...
```typescript name=file-handler. ts url=https://github.com/elastic/kibana/blob/main/oas_docs/scripts/lib/file-handler.ts
/*
 * Copyright Elasticsearch B.V. and/or licensed to Elasticsearch B.V. under one
 * or more contributor license agreements. Licensed under the "Elastic License
 * 2.0", the "GNU Affero General Public License v3.0 only", and the "Server Side
...
```typescript name=report-generator.ts url=https://github.com/elastic/kibana/blob/main/oas_docs/scripts/lib/report-generator.ts
/*
 * Copyright Elasticsearch B.V. and/or licensed to Elasticsearch B.V. under one
 * or more contributor license agreements. Licensed under the "Elastic License
 * 2.0", the "GNU Affero General Public License v3.0 only", and the "Server Side
...
```typescript name=validator.ts url=https://github.com/elastic/kibana/blob/main/oas_docs/scripts/lib/validator.ts
/*
 * Copyright Elasticsearch B.V. and/or licensed to Elasticsearch B.V. under one
 * or more contributor license agreements. Licensed under the "Elastic License
 * 2.0", the "GNU Affero General Public License v3.0 only", and the "Server Side
...
```typescript name=cli-handler.ts url=https://github.com/elastic/kibana/blob/main/oas_docs/scripts/lib/cli-handler.ts
/*
 * Copyright Elasticsearch B.V. and/or licensed to Elasticsearch B.V. under one
 * or more contributor license agreements. Licensed under the "Elastic License
 * 2.0", the "GNU Affero General Public License v3.0 only", and the "Server Side
...
```typescript name=extract-inline-schemas.ts url=https://github.com/elastic/kibana/blob/main/oas_docs/scripts/extract-inline-schemas.ts
#!/usr/bin/env node
...
```typescript name=index. ts url=https://github.com/elastic/kibana/blob/main/oas_docs/scripts/lib/index.ts
/*
 * Copyright Elasticsearch B. V. and/or licensed to Elasticsearch B.V. under one
 * or more contributor license agreements.  Licensed under the "Elastic License
 * 2.0", the "GNU Affero General Public License v3.0 only", and the "Server Side
...
```json name=tsconfig.json url=https://github.com/elastic/kibana/blob/main/oas_docs/scripts/tsconfig. json
{
  "compilerOptions": {
    "target":  "ES2020",
    "module": "commonjs",
...
```markdown name=README.md url=https://github.com/elastic/kibana/blob/main/oas_docs/scripts/README.md
