...
import { buildKibanaQueryBarDataFilter } from '../kibana_query_bar_data';
import filterSkeleton from '../../__fixtures__/filter_skeleton';

let expected;
describe('Filter Manager', function () {
  describe('Kibana querybar data filter builder', function () {
    beforeEach(() => {
      expected = cloneDeep(filterSkeleton);
    });

    it('should be a function', function () {
      expect(buildKibanaQueryBarDataFilter).to.be.a(Function);
    });
