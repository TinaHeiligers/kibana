...
export const parseRedoclyCompatibilityIssues = (stdout: string): CompatibilityIssue[] => {
  ...
  // Redocly `warn` problems are intentionally dropped in policy v1; mapping them to
  // `warning`-severity issues is a follow-up (see kbn-validate-oas error_categorization).
  return problems
