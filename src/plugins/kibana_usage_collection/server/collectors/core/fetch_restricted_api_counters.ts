...
import { CoreRestrictedApiUsageStats } from '@kbn/core-usage-data-server/src';
import { createCounterFetcher, type CounterEvent } from '../common/counters';

const RESTRICTED_API_COUNTERS_FILTER = `${USAGE_COUNTERS_SAVED_OBJECT_TYPE}.attributes.counterType: deprecated_api_call\\:*`;
